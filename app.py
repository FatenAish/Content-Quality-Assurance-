...
def audit_content(url, soup, body_text, focus_keyword="", secondary_keywords=None):
    ...
    authoritative_claim_issues = authoritative_review_claims(article_soup)
    ...
    deterministic_data_issues = deterministic_data_quality_issues(article_soup)
...
if run:
    ...
    try:
        ...
        st.download_button(
            ...
            data=excel_report,
            file_name="url_audit_report_v18_57.xlsx",
